   ...
   <footer class="footer <?php echo $pushdown ?>">
        <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <h2>Contact Us</h2>
                <ul class="footer-contact-icons">
                    ...
                    <li><a href="javascritp:void(0)"><i class="fa fa-envelope"></i>&nbsp;&nbsp;info@fashionee.com</a></li>
                    <li><a href="javascritp:void(0)"><i class="fa fa-skype"></i>&nbsp;&nbsp;info.fashionee</a></li>
                </ul>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-sm-offset-2 text-center copyright">
                <p>&copy; 2015 Fashionee. All rights reserverd.</p>
