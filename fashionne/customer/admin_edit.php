  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-default mr-top-20">
        <div class="panel-heading">Edit Member Details</div>
        <div class="panel-body">
        <form id="signupForm" class="mr-top-20" method="POST" action="admin_apply_edit.php" accept-charset="UTF-8">
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-asterisk fa-2"></i></span>
            <input id="fname" value="<?php echo $row['fname']; ?>" class="form-control input-lg" placeholder="Firstname" required="required" maxlength="60" type="text" name="fname">
          </div>
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-asterisk fa-2"></i></span>
            <input id="lname" value="<?php echo $row['lname']; ?>" class="form-control input-lg" placeholder="Lastname" required="required" maxlength="60"type="text" name="lname">
          </div>
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-asterisk fa-2"></i></span>
            <input id="phone" value="<?php echo $row['phone']; ?>"  class="form-control input-lg" placeholder="Phone" required="required" maxlength="60" type="text" name="phone">
          </div>
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-asterisk fa-2"></i></span></span><span>&nbsp;State&nbsp;</span>
          ...
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-asterisk fa-2"></i></span>&nbsp;Membership Type&nbsp;
            <input type="radio" name="type" value="silver" <?php if($row['type'] =="silver"){ echo "checked";}?> > Silver (2 Years)</input>
            <input type="radio" name="type" value="gold" <?php if($row['type'] == "gold"){ echo "checked";}?> > Gold (3 Years)</input>
            <input type="radio" name="type" value="platinum" <?php if($row['platinum'] == "platinum"){ echo "checked";}?> > Platinum (5 Years)</input>
          </div>
          <div class="input-group">
